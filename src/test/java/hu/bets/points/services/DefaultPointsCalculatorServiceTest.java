...
public class DefaultPointsCalculatorServiceTest {
    ...
    public void perfectTipShouldResultInTenPointsHomeWins() {
        Result tip = new Result("competitionId", "1", "2", 1, 0);
        Result result = new Result("competitionId", "1", "2", 1, 0);
    ...
    public void perfectTipShouldResultInTenPointsAwayWins() {
        Result tip = new Result("competitionId", "1", "2", 0, 1);
        Result result = new Result("competitionId", "1", "2", 0, 1);
    ...
    public void perfectTipShouldResultInTenPointsDraw() {
        Result tip = new Result("competitionId", "1", "2", 1, 1);
        Result result = new Result("competitionId", "1", "2", 1, 1);
    ...
    public void guessingOutcomeAndOneTeamsGoalsResultsInSevenPointsWhenHomeWins() {
        Result tip = new Result("competitionId", "1", "3", 2, 1);
        Result result = new Result("competitionId", "1", "2", 9, 1);
    ...
    public void guessingOutcomeAndOneTeamsGoalsResultsInSevenPointsWhenAwayWins() {
        Result tip = new Result("competitionId", "1", "3", 1, 2);
        Result result = new Result("competitionId", "1", "2", 1, 3);
    ...
    public void guessingOutcomeResultsInFivePointsHomeWins() {
        Result tip = new Result("competitionId", "1", "3", 2, 1);
        Result result = new Result("competitionId", "1", "2", 9, 0);
    ...
    public void guessingOutcomeResultsInFivePointsDraw() {
        Result tip = new Result("competitionId", "1", "3", 2, 2);
        Result result = new Result("competitionId", "1", "2", 0, 0);
    ...
    public void guessingHomeTeamsGoalsResultsInTwoPoints() {
        Result tip = new Result("competitionId", "1", "3", 2, 1);
        Result result = new Result("competitionId", "1", "2", 2, 3);
